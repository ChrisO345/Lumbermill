package com.chrisoliver345.lumbermill.block;
...
public class LumbermillBlock extends Block
{
    private static final TranslationTextComponent CONTAINER_TITLE = new TranslationTextComponent("container.lumbermill.lumbermill");
    ...
    public LumbermillBlock(Properties properties)
    {
        super(properties);
    ...
    public INamedContainerProvider getContainer(BlockState state, World world, BlockPos pos)
    {
        return new SimpleNamedContainerProvider((windowId, playerInventory, playerEntity) -> {
            return new LumbermillContainer(windowId, playerInventory, IWorldPosCallable.of(world, pos));
        }, CONTAINER_TITLE);
    }
